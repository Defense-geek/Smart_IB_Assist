...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/mm/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/mm/Documents/hackathon/smart_ib_assist/.buildozer/android/platform/build-arm64-v8a/build/python-installs/smartibassist/arm64-v8a/include/python3.9" ],
  CPPINCLUDES => [  ],
  CXX => "/home/mm/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android26 -fomit-frame-pointer -march=armv8-a -fPIC",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/mm/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
